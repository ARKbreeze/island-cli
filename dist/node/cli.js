...
var cli = (0, cac_1.cac)('island').version(version).help();
//注册dev命令
cli
    .command('[root]', '启动开发服务')
    .alias('dev')
    .action(function (root) { return __awaiter(void 0, void 0, void 0, function () {
    var server;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, dev_1.createServer)(root)];
            case 1:
                server = _a.sent();
